...
import { CHECK_DESCRIPTIONS } from '@/shared/domain/inspection/check-descriptions';
import {
  BarChart,
  Bar,
  LineChart,
...
import { ChartContainer } from '@/frontend/components/ui/chart';
...
import {
  ...
  measurementTicks,
  chartNumber,
} from '@/shared/domain/inspection/chart-scale';
import { formatTime } from '@/shared/domain/inspection/types';
import type { Station, Inspection, LocalRow } from '@/shared/domain/inspection/types';
